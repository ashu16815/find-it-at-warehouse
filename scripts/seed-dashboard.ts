...
async function run() {
  ...
  const domains = [
    ...
    { domain: 'pbtech.co.nz', merchant: 'PB Tech', label: 'External' },
    { domain: 'harveynorman.co.nz', merchant: 'Harvey Norman', label: 'External' },
    { domain: 'amazon.com.au', merchant: 'Amazon', label: 'External' }
  ];
